...
You can run any of the following files you wish. Please read the disclaimer below before running it.

.bat file
.reg file
.ps1 file

Disclaimer: Please run this program at your own risk and check the codes before running. I won't be liable for any issues caused by the program after running it.
